"""
Django settings for e_hammond project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'contacts.contexts.contacts_inbox'
            ],
        },
    },
]
...
if 'USE_AWS' in os.environ:
    AWS_STORAGE_BUCKET_NAME = 'e-hammond'
    ...
    MEDIAFILES_LOCATION = 'media'   # for AWS S3
